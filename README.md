...
11. Force-refresh custom app icons and configure Pictogram's signed login helper to preserve them across app updates. Adobe-managed apps are deliberately excluded so Creative Cloud can patch their signed bundles safely.
